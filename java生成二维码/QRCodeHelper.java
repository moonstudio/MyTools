...
public class QRCodeHelper {
     ...
     * @param iconPath  二维码图片中间的图标文件路径
     * @param exportPath 生成二维码图片完整的路径
     */  
    public int createQRCode(String content, String iconPath, String exportPath) {  
    	System.out.println("开始生成二维码..."); // TODO System.out.println();
        try {  
            ...
            gs.setBackground(Color.WHITE);	// 底色
            gs.setColor(Color.BLACK);		// 码色
            ...
            System.out.println("二维码生成完毕！"); // TODO System.out.println();
        } catch (Exception e) {  
            e.printStackTrace();  
            return -100;
        }  
    ...
    public static void main(String[] args) {
    	 ...
    	 String encoderContent = "万达智慧教育平台 - edu.wondersgroup.com";
